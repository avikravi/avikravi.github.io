...
| `/hp/p66-example` | `hp/p66-example/index.html` | Added 2026-08-23, nested under AI Research in the sidebar. Embeds an independent pressure-vessel integrity prototype (ML corrosion prediction, fleet risk dashboard, ASME/API standards), live on Vercel at p66-vessel-integrity.vercel.app — synthetic data only, explicitly unaffiliated with Phillips 66 (a disclaimer the embedded app repeats in its own header). |
