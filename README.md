...
| `/hp/30-60-90` | `hp/30-60-90/index.html` | Added 2026-08-27. A 30/60/90-day plan for the real HP Principal TPMM, AI Solutions role, for post-interview follow-up. First (and so far only) page in a new "Post Interview" grouped section in the sidebar, visually separated from the six flat links above it. Guiding Principles intro, then three day-range sections (1-30, 31-60, 61-90) each with a stacked Goals / Key Activities / Deliverables / Success Metrics breakdown, written to reference the real gaps documented on `/hp` itself and commit to closing them on a timeline. |
