...
| `/hp/p66-example` | `hp/p66-example/index.html` | Added 2026-08-23, nested under AI Research in the sidebar. Describes an independent pressure-vessel integrity prototype (ML corrosion prediction, fleet risk dashboard, ASME/API standards) — synthetic data only, explicitly unaffiliated with Phillips 66. Not deployed publicly yet, so this links out to the GitHub repo rather than embedding it. |
