...
| `/hp/youtube` | `hp/youtube/index.html` | Youtube playlist of Avi's AI/ML project videos — a "now playing" embed plus a thumbnail grid (one card per video, click to switch). The video list (`hp/youtube/videos.json`) is manually maintained, not live-synced — see `CLAUDE.md` for why. |
