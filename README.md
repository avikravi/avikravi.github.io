...
| `/hp/object-detect-summary` | `hp/object-detect-summary/index.html` | Added 2026-09-20. First page in a new "Object Detect" grouped sidebar section, for a separate object-detection project. Placeholder for now — will hold a slide-deck presentation once Avi provides it. |
| `/hp/object-detect-level-1` | `hp/object-detect-level-1/index.html` | Added 2026-09-20, second link in the "Object Detect" section. Placeholder — content to be provided. |
